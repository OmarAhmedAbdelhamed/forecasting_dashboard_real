...
export function ForecastingSection() {
  ...
  // NEW STATES
  const [pricingMode, setPricingMode] = useState<'discount' | 'price'>('discount');
  ...
  const [selectedCampaign, setSelectedCampaign] = useState<SimilarCampaign | null>(null);
  ...
  const handleAnalyze = async () => {
    ...
    if (pricingMode === 'price' && targetPrice) {
       discount = ((baseSatisFiyati - parseFloat(targetPrice)) / baseSatisFiyati) * 100;
       // Safety check
  ...
  const totalPotentialForecast = 
    forecastData?.reduce((acc, curr) => acc + (curr.unconstrained_demand || curr.tahmin || 0), 0) || 0;
          ...
          <Card className='h-fit'>
            ...
            <CardContent className='space-y-2 2xl:space-y-3 pb-2 2xl:pb-3'>
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Analiz edilecek coğrafi bölgeleri seçiniz.</p></UITooltipContent>
                  </UITooltip>
                </div>
                <MultiSelect
                  options={REGIONS}
              ...
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Spesifik mağaza performansı için seçim yapınız.</p></UITooltipContent>
                  </UITooltip>
                </div>
                <MultiSelect
                  options={STORES}
              ...
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Ürün kategorisine göre filtreleme yapınız.</p></UITooltipContent>
                  </UITooltip>
                </div>
                <MultiSelect
                  options={CATEGORIES}
              ...
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Tahmin yapılacak spesifik ürünleri (SKU) seçiniz.</p></UITooltipContent>
                  </UITooltip>
                </div>
                <MultiSelect
                  options={PRODUCTS}
              ...
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Talep tahmininin görüntüleneceği aralığı belirleyiniz.</p></UITooltipContent>
                  </UITooltip>
                </div>
              ...
              <div className='space-y-0.5'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Promosyonun uygulanacağı aktif günleri seçiniz.</p></UITooltipContent>
                  </UITooltip>
                </div>
                <div className='grid grid-cols-2 gap-2'>
                  <DatePicker
              ...
              <div className='bg-muted/30 p-2 rounded-lg border space-y-2'>
                <div className='flex items-center justify-between'>
                  <div className="flex items-center gap-1">
                    ...
                    <UITooltip>
                      ...
                      <UITooltipContent><p>Promosyonun indirim oranı veya hedef satış fiyatı üzerinden kurgulanması.</p></UITooltipContent>
                    </UITooltip>
                  </div>
                ...
                <Tabs value={pricingMode} onValueChange={(v) => setPricingMode(v as 'discount' | 'price')} className="w-full">
                  <TabsList className="grid w-full grid-cols-2 h-7">
                    <TabsTrigger value="discount" className="text-[10px] h-5">İndirim Oranı</TabsTrigger>
                    <TabsTrigger value="price" className="text-[10px] h-5">Hedef Fiyat</TabsTrigger>
                  </TabsList>
                ...
                {/* Info Display for the other value */}
                 <div className="text-[10px] text-muted-foreground text-center bg-background/50 py-0.5 rounded border">
                    {pricingMode === 'discount' ? (
                       <>Satış Fiyatı: <span className="font-medium text-foreground">{targetPrice || '...'} TL</span></>
                    ) : (
                       <>İndirim Oranı: <span className="font-medium text-foreground">% {promosyonIndirimOrani || '...'}</span></>
                    )}
                 </div>
              </div>
               ...
               <div className='space-y-0.5'>
                 <div className="flex items-center gap-1">
                   ...
                   <UITooltip>
                      ...
                      <UITooltipContent><p>Maksimum kampanya bütçesi. ROI hesabında kullanılır.</p></UITooltipContent>
                   </UITooltip>
                 </div>
                 <Input
                   type='number'
                 ...
                 />
                 <p className="text-[10px] text-muted-foreground">ROI hesaplaması için kullanılır.</p>
               </div>
             ...
             <Card className='h-fit border-indigo-100 bg-indigo-50/20'>
               <CardHeader className='py-2 pb-1 2xl:py-3'>
                 <div className="flex items-center gap-2">
                   ...
                   <UITooltip>
                     ...
                     <UITooltipContent><p>Geçmişte benzer özellikler gösteren kampanyaların performans analizi.</p></UITooltipContent>
                   </UITooltip>
                 </div>
               ...
               <CardContent className='space-y-2 p-3'>
                  {filteredCampaigns.map((camp) => (
                    <div key={camp.id} className="bg-white border rounded-lg p-2 hover:shadow-sm transition-shadow">
                       <div className="flex justify-between items-start mb-1">
                          <div>
                            <div className="font-semibold text-xs text-indigo-950">{camp.name}</div>
                            <div className="text-[10px] text-muted-foreground">{camp.date} • {camp.type}</div>
                          </div>
                       ...
                       <div className="grid grid-cols-3 gap-1 text-[10px] text-muted-foreground mb-2">
                          <div className="flex flex-col">
                             <span className="font-medium text-emerald-600">%{camp.lift}</span>
                             <span>Lift</span>
                          </div>
                          <div className="flex flex-col">
                             <span className="font-medium text-blue-600">%{camp.roi}</span>
                             <span>ROI</span>
                          </div>
                          <div className="flex flex-col">
                             <span className={`font-medium ${camp.stockOutDays > 0 ? 'text-red-500' : 'text-gray-600'}`}>
                               {camp.stockOutDays} G
                             </span>
                             <span>OOS</span>
                          </div>
            ...
            <CardHeader className='py-3 pb-2 2xl:py-4'>
              <div className="flex items-center gap-1">
                ...
                <UITooltip>
                  ...
                  <UITooltipContent><p>Promosyon planlamasında değerlendirilebilecek önemli günler.</p></UITooltipContent>
                </UITooltip>
              </div>
              <CardDescription className='text-xs 2xl:text-sm'>
        ...
        <div className='lg:col-span-8 space-y-2 2xl:space-y-3'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-2 2xl:gap-3'>
              ...
              <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-1 py-2 2xl:py-3'>
                <div className="flex items-center gap-2">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent>
                      <p className="max-w-xs">Promosyon süresince satılması öngörülen toplam ürün adedi.</p>
                    </UITooltipContent>
                  </UITooltip>
                </div>
              ...
              <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-1 py-2 2xl:py-3'>
                <div className="flex items-center gap-2">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent>
                      <p className="max-w-xs">İndirimli fiyat üzerinden hesaplanan tahmini toplam satış geliri.</p>
                    </UITooltipContent>
                  </UITooltip>
                </div>
            ...
            <Card>
              <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-1 py-2 2xl:py-3'>
                <div className="flex items-center gap-2">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent>
                      <p className="max-w-xs">Yatırım Getirisi: (Net Kar / Promosyon Maliyeti) x 100.</p>
                    </UITooltipContent>
                  </UITooltip>
                </div>
              ...
              <CardContent className='pb-2 2xl:pb-3'>
                <div className={`text-lg 2xl:text-xl font-bold ${calculatedROI >= 0 ? 'text-emerald-600' : 'text-red-600'}`}>
            ...
            <Card>
                ...
                <div className="flex items-center gap-2">
                  <CardTitle className='text-xs 2xl:text-sm font-semibold'>
                   ...
                   <UITooltip>
                    ...
                    <UITooltipContent>
                      <p className="max-w-xs">Mevcut stokun tahmin edilen talebi karşılama durumu.</p>
                    </UITooltipContent>
                  </UITooltip>
                </div>
              ...
              <CardContent className='pb-2 2xl:pb-3'>
                <div className={`text-lg 2xl:text-xl font-bold ${lostSalesVolume > 0 ? 'text-red-600' : 'text-emerald-600'}`}>
                   {lostSalesVolume > 0 ? 'Riskli' : 'Güvenli'}
                </div>
                <p className='text-[10px] 2xl:text-xs text-muted-foreground'>
                   {lostSalesVolume > 0 ? `-${lostSalesVolume} OOS` : 'Yeterli Stok'}
                </p>
              </CardContent>
            </Card>
          </div>
                ...
                <div className='flex items-center justify-between px-3 py-2 border-b'>
                  <div className='space-y-0.5'>
                    <div className="flex items-center gap-1">
                      ...
                      <UITooltip>
                        ...
                        <UITooltipContent><p>Promosyonlu satış (yeşil) ile normal satış beklentisinin (siyah) karşılaştırması.</p></UITooltipContent>
                      </UITooltip>
                    </div>
                    <p className='text-[10px] 2xl:text-xs text-muted-foreground'>
                  ...
                  <div className='flex items-center gap-3 text-[10px]'>
                     <div className='flex items-center gap-1.5'>
                      ...
                      <span className='text-muted-foreground font-medium'>Temel</span>
                    </div>
                     <div className='flex items-center gap-1.5'>
                      <span className='w-2 h-2 rounded-full bg-[#22c55e]' />
                      <span className='text-muted-foreground font-medium'>Simüle</span>
                    </div>
                     <div className='flex items-center gap-1.5'>
                      <span className='w-2 h-2 rounded-full bg-red-400 opacity-80' style={{ borderStyle: 'dashed', borderWidth: 1 }} />
                      <span className='text-muted-foreground font-medium'>Kaçan</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex items-center justify-between mb-1'>
                    <div className='flex items-center gap-2'>
                      ...
                      <UITooltip>
                        ...
                        <UITooltipContent><p>Seçilen dönemde en yüksek ROI getiren kampanya tipi.</p></UITooltipContent>
                      </UITooltip>
                    </div>
                  ...
                  <div className='flex items-center justify-between mb-1'>
                    <div className='flex items-center gap-2'>
                      ...
                      <UITooltip>
                        ...
                        <UITooltipContent><p>Stok yetersizliği nedeniyle kaçırılacak satış riski.</p></UITooltipContent>
                      </UITooltip>
                    </div>
                  </div>
                  <div className='space-y-0.5'>
                    ...
                    <div className='flex items-baseline gap-2'>
                      <span className='text-xl 2xl:text-2xl font-black text-red-600 tracking-tighter'>
                        {lostSalesVolume > 0 ? `${lostSalesVolume} Adet` : '0 Adet'}
                      </span>
                      <span className='text-[10px] 2xl:text-xs text-muted-foreground font-medium'>
                        Stock-Out
                      </span>
                    ...
                    {/* Financial Warning */}
                     <div className="mt-1 text-[10px] bg-red-100/50 p-1 rounded text-red-800 font-medium">
                        ...
                        <span className="block font-normal opacity-80">(Acil sipariş farkı)</span>
                     </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className='flex items-center justify-between mb-1'>
                    <div className='flex items-center gap-2'>
                      ...
                      <UITooltip>
                        ...
                        <UITooltipContent><p>Bu kampanyanın benzer ürünlerin ortalamasına göre performansı.</p></UITooltipContent>
                      </UITooltip>
                    </div>
                  </div>
                  <div className='space-y-0.5'>
              ...
              <CardHeader className='py-2 pb-1 2xl:py-3'>
                <div className="flex items-center gap-1">
                  ...
                  <UITooltip>
                    ...
                    <UITooltipContent><p>Farklı promosyon kurgularının karlılık (ROI) ve ciro artışı (Lift) karşılaştırması.</p></UITooltipContent>
                  </UITooltip>
                </div>
              ...
              <CardContent className='pt-1 pb-2'>
                  ...
                  <div className='space-y-2'>
                    {[
                      ...
                      { type: 'ALISVERIS_INDIRIMI_500', roi: 45, lift: 60, color: 'bg-blue-500' },
                      {
                        type: 'COKLU_ALIM',
                        roi: 60,
                        lift: 40,
